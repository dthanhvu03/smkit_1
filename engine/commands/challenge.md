...
2. Run the **pre-build-critique** skill: challenge it through every lens — correctness, security & data, consistency, simplicity/necessity, reversibility (one-way vs two-way door), and a **pre-mortem** (imagine it failed months later — the single most likely reason). Reason at **senior depth** (the **senior-reasoning** skill): each finding carries a *why* + a *consequence*, not a one-line "looks fine"; steelman the change before you clear it.
