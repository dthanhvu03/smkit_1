...
name: "ui-review"
description: "Use when UI has been built or changed, before finishing. Invoke to check the interface for accessibility (a concrete WCAG 2.2 subset), the missing states UI usually ships without (loading/empty/error), responsive breakage, and design-token drift. The visual/a11y counterpart to code-review, which covers logic and security."
license: "Apache-2.0"
